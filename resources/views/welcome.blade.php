    ...
    <body>
            <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
              <div class="container"  style="font-size:20px;">
                    <a class="navbar-brand"  style="font-size:30px;" href="{{ url('/') }}">ORVBA</a>
               ...
               <div class="row justify-content-center ">
                  <div class="col-md-12 ">
                    ...
                    <div class="col-10"style="font-size:20px; text-align:center;">
                      for feedback and support contact admin@gmail.com
                  </div>            
               </div>  
